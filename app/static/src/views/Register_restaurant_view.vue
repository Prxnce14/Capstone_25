                ...
                <form @submit.prevent="register_restaurant" id="restaurantform" class="signup-form">
                    ...
                    <div class="form-fields">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="restaurant@example.com" required />
                        </div>

                        <div class="form-group">
                            <label for="phone_number">Phone number</label>
                            <input type="text" name="phone_number" class="form-control" placeholder="876-237-2799" required />
                        </div>

                        <div class="form-group">
                            <label for="store_name">Restaurant Name</label>
                            <input type="text" name="store_name" class="form-control" placeholder="KFC" required />
                        </div>

                        <div class="form-group">
                            <label for="store_address">Restaurant Address</label>
                            <input type="text" name="store_address" class="form-control" placeholder="9B Chancellor UWI, 7, Ring Rd, Kingston" required />
                        </div>
...
<script setup>
    ...
    function validateForm() {
        ...
        const storeName = form.querySelector('input[name="store_name"]').value;
        const storeAddr = form.querySelector('input[name="store_address"]').value;
        
        // Check required fields (add more as needed)
        if (!password || !confirmPassword || !email || !storeName || !storeAddr) {
    ...
    function register_restaurant() {
        ...
        let reg_form = document.querySelector("#restaurantform");
        let form_data = new FormData(reg_form);

        // Extract username and store name to use in success message
