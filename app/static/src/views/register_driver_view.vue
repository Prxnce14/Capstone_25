                ...
                <form @submit.prevent="register_driver" id="driverform" class="signup-form">
                    ...
                    <div class="form-fields">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="firstname" class="form-control" placeholder="Mark" required />
                        </div>

                        <div class="form-group">
                            <label for="lastname">Lastname</label>
                            <input type="text" name="lastname" class="form-control" placeholder="Black" required />
                        </div>

                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" name="email" class="form-control" placeholder="markblack@gmail.com" required />
                        </div>
